...
void IRsend::space(int time) {
	digitalWrite(NE555PIN,LOW); // used to include Proximity

	delayMicroseconds(time);
}
void IRsend::stop()                     // written to use send and receive in the same sketch
{
	pinMode(NE555PIN, OUTPUT);
	Serial.println("stopping pin 3");
	digitalWrite(NE555PIN,LOW);
}

void IRsend::enableIROut(int khz) {
	pinMode(NE555PIN, OUTPUT);// used to include Proximity
}
